  ...
  return (
    ...
    >
      ...
      <div className="bg-white border border-neutral-200 rounded-xl p-8 sm:p-10 shadow-soft relative overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute top-0 right-0 w-40 h-40 bg-green-50 rounded-full -translate-y-20 translate-x-20 opacity-40"></div>
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-green-50 rounded-full translate-y-16 -translate-x-16 opacity-30"></div>
        ...
        >
          <div className="relative">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-green-500 to-green-600 flex items-center justify-center shadow-green">
              <svg
        ...
        <motion.div
          ...
          className="table-card border-2 border-green-500 rounded-xl p-8 mb-6 text-center bg-gradient-to-br from-green-50 to-white relative overflow-hidden shadow-soft"
        >
          {/* Background pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle,rgb(34,197,94)_1px,transparent_1px)] bg-[length:16px_16px]"></div>
          </div>
          
          <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="text-left flex-1">
              <p className="text-xs font-medium text-green-700 mb-1 uppercase tracking-widest">
                Assigned Table
              </p>
              <div className="text-6xl font-bold bg-gradient-to-br from-green-600 to-green-700 bg-clip-text text-transparent tracking-tight">
                {tableNumber}
              </div>
            </div>
            <div className="text-right">
              ...
              <div className="text-4xl font-bold bg-gradient-to-br from-green-600 to-green-700 bg-clip-text text-transparent">
                {seatNumber}
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            ...
            <p className="text-xs text-neutral-600">
              {seatNumber} of 6 seats at your table
            </p>
          </div>
        </motion.div>
        ...
        >
          <button
            ...
            className="w-full py-3 px-4 border-2 border-neutral-200 hover:border-green-500 rounded-lg text-sm font-medium text-neutral-700 hover:text-green-700 hover:bg-green-50 transition-all duration-150 flex items-center justify-center gap-2"
          >
        ...
        >
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-neutral-600">
                Each table accommodates up to 6 guests
              </p>
            </div>
          </div>
        </motion.div>
